...
do
  ...
  -- Ghostty bundles Nerd Font icons as fallbacks, regardless of configured font
...
-- ============================================================
-- SECTION 6: LSP
-- LSP keymaps, server configuration (binaries managed via mise)
-- ============================================================
do
  -- [[ LSP Configuration ]]
  ...
  -- Neovim. Language server binaries are installed and managed via mise (see .mise/config.toml).
  --
